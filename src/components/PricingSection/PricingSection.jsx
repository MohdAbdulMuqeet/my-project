...
const AnimatedButton = ({ children, className = "" }) => {
  return (
    <button
      className={`bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white font-semibold px-8 py-3 rounded-xl hover:from-purple-600 hover:to-fuchsia-600 transition-all duration-300 transform hover:scale-105 ${className}`}
    >
      {children}
    </button>
  );
  ...
  <div className="flex flex-col lg:flex-row gap-12 items-center justify-center max-w-screen-xl mx-auto">
    ...
    <div
      className="relative 
        ...
        px-6 sm:px-8 md:px-12 py-10 sm:py-12 md:py-14 
        border border-purple-500/50 
        overflow-hidden 
        shadow-xl shadow-purple-700/30 
        w-full lg:w-1/2 min-h-[600px] sm:min-h-[700px] md:min-h-[750px]"
    >
      <CardGridBackground />
      ...
      <div className="relative z-10">
        {/* Plan Selection */}
        {/* ✅ CHANGE: stacked on mobile, row on md+ */}
        ...
        <AnimatedButton
          className="w-full sm:w-auto px-4 sm:px-6 md:px-10 lg:px-16 py-3 sm:py-4 text-base sm:text-lg md:text-xl rounded-2xl font-bold"
        >
          Get Started Now →
        </AnimatedButton>
      </div>
