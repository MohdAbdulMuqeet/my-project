...
const SixCardSection = () => {
  ...
  <div className="text-center mb-20">
    ...
    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-cyan-500">
      of each AI model
    </h2>
  </div>
  ...
  <div className="relative w-full max-w-7xl mx-auto">
    {/* ✅ Desktop / Tablet View (Hub + Cards) */}
    <div className="relative hidden md:flex items-center justify-center min-h-[600px]">
      {/* Central Hub */}
...
<div className="relative p-[1px] rounded-2xl bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500">
  {/* Inner Card */}
  <div className="w-96 p-6 rounded-2xl backdrop-blur-sm bg-gray-900/90">
    ...
    {/* ✅ Mobile View (Just cards stacked) */}
    <div className="flex flex-col gap-6 md:hidden">
      {aiModels.map((model) => (
        <div
          key={model.id}
          className="w-full p-6 rounded-2xl backdrop-blur-sm border border-gray-700/50 bg-gray-900/80"
        >
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 bg-teal-400/20 rounded-full flex items-center justify-center border border-teal-400/30">
              <span className="text-xl">{model.icon}</span>
